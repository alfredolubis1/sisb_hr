...
class employee_summary_overtime(models.TransientModel):
    _name = "employee.summary.overtime"
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        print('datas = ', datas)
        return self.pool['report'].get_action(cr, uid, [], 'sisb_hr.employee_summary_overtime', data=datas, context=context)
