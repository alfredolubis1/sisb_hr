 ...
 *     This event is not related to the on_change mechanism of TigernixERP and is always called
...
instance.web.form.FieldManagerMixin = {
    ...
    */
    ...
    /**
    Computes an TigernixERP domain.

    @param {Array} expression An TigernixERP domain.
    ...
    */
    ...
    @return {CompoundContext} An TigernixERP context.
    */
...
instance.web.FormView = instance.web.View.extend(instance.web.form.FieldManagerMixin, {
     ...
     * @param {String} view_id the identifier of the TigernixERP view object
...
instance.web.form.FieldInterface = {
     ...
     * osv class in the TigernixERP server as well as the syntax used by the set_value() (see below). It must
     ...
     * the TigernixERP server, although it is not assumed to respect the constraints applied to the field.
...
instance.web.form.AbstractField = instance.web.form.FormWidget.extend(instance.web.form.FieldInterface, {
    ...
    */
     ...
     * value is similar to false in TigernixERP.
     */
    is_false: function() {
...
instance.web.form.FieldStatus = instance.web.form.AbstractField.extend({
    ...
    /*
     * :deprecated: this feature will probably be removed with TigernixERP v8
     */
    ...
    on_click_stage: function (ev) {
        ...
        var val;
        if (this.field.type == "many2one") {
            if (!confirm(_t("Warning.\n\nAre you sure you want to change this Application State?"))) {
                return false;
            }
 ...
 * will substitute to the <field> tags as defined in TigernixERP's views.
 */
instance.web.form.widgets = new instance.web.Registry({
    ...
    'float2_time': 'instance.web.form.FieldFloat',
    'day_time': 'instance.web.form.FieldFloat',
 ...
 * tags defined in TigernixERP's form views.
 *
